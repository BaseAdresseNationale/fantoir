...
function initVoie(voie) {
  return {
    id: voie.hid,
    dateAjout: voie.date_ajout,
    libelle: [],
    typeVoie: voie.type_voie,
    codeCommune: voie.code_commune,
    codeFantoir: voie.code_rivoli
  }
}
...
class Model {
  ...
  upsertCommune(commune) {
    ...
    if (commune.date_annulation && !this._handledCancelledCommunes.has(codeCommune)) {
